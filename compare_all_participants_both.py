...
def single_part(path_act, path_change, path_act_i, path_change_i):
    ...
    for block in range(n_blocks):
        ...
        best_count_c_curr, mid_count_c_curr, worst_count_c_curr, correct_ans_c = part_block(comp_actions, stim_1_prob,
...
paths_act=['C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_pe_p_example_results_action_observation.csv', \
           'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/8998_pe_p_example_results_action_observation.csv', \
           'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/0_pe_p_example_results_action_observation.csv',\
           'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_r_p_example_results_action_observation.csv', \
...
paths_change=['C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_pe_p_example_results_new.csv',\
              'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/8998_pe_p_example_results_new.csv',\
              'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/0_pe_p_example_results_new.csv',\
              'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_r_p_example_results_new.csv', \
...
paths_act_i=['C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_pe_i_example_results_action_observation.csv', \
           'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/8998_pe_i_example_results_action_observation.csv', \
           'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/0_pe_i_example_results_action_observation.csv',\
...
paths_change_i=['C:/Users/magda/PycharmProjects/Rascola_Wagner/data/9598_pe_i_example_results_new.csv',\
              'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/8998_pe_i_example_results_new.csv',\
              'C:/Users/magda/PycharmProjects/Rascola_Wagner/data/0_pe_i_example_results_new.csv', \
...
x3=[1.4,2.4]
ax = plt.subplot(111)
ax.bar(x, [best_count_p_all, best_count_c_all], width=0.2, color='mediumseagreen',alpha=0.5, align='center', label='correct')
ax.bar(x, [rew_best_p_all, rew_best_c_all], width=0.17, color='mediumseagreen', align='center')
ax.bar(x2, [mid_count_p_all, mid_count_c_all], width=0.2, color='yellow', alpha=0.4, align='center', label='2nd best')
ax.bar(x2, [rew_mid_p_all, rew_mid_c_all], width=0.17, color='yellow', align='center')
ax.bar(x3, [worst_count_p_all, worst_count_c_all], width=0.2, color='red',alpha=0.5, align='center', label='incorrect')
ax.bar(x3, [rew_worst_p_all, rew_worst_c_all], width=0.17, color='red', align='center')
...
title='all participants, instrumental vs pavlovian'
ax.set_title(title)
