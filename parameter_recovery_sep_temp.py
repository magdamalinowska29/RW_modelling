...
for i in range(count):
    ...
    RW=Rescorla_Wagner_sep_temp_model()
    """simulation"""
    a,r=RW.simulate_change(500, [0.5,0.5,0.5], alpha, beta, beta_new, changepoints, new_pos, new_probs)
...
results_3=pearsonr(beta_new_sim,beta_new_fit)
...
plt.scatter(beta_new_sim,beta_new_fit,c='magenta')
#plt.show()
#plt.scatter(beta_sim_bad,beta_fit_bad,c='grey')
plt.title('beta new')
plt.grid()
