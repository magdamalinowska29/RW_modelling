...
for block in range(n_blocks):
    ...
    best_count_p, mid_count_p, worst_count_p, correct_ans_p=part_block(actions,stim_1_prob_i, stim_2_prob_i, stim_3_prob_i, block_end, block_start)
    ...
    rew_best_p, rew_mid_p, rew_worst_p=count_rewards(correct_ans_p,observations, block_start)

    print(rew_best_p)
    print(rew_mid_p)
    print(rew_worst_p)

    best_count_c, mid_count_c, worst_count_c, correct_ans_c=comp_block(comp_actions,stim_1_prob, stim_2_prob, stim_3_prob, block_end, block_start)

    rew_best_c, rew_mid_c, rew_worst_c=count_rewards(correct_ans_c,comp_obs, block_start)
    ...
    x3=[1.4,2.4]
    ax = plt.subplot(111)
    ax.bar(x, [best_count_p, best_count_c], width=0.2, color='darkgreen',alpha=0.5, align='center', label='correct')
    ax.bar(x, [rew_best_p, rew_best_c], width=0.17, color='darkgreen', align='center')
    ax.bar(x2, [mid_count_p, mid_count_c], width=0.2, color='gold', alpha=0.4, align='center', label='2nd best')
    ax.bar(x2, [rew_mid_p, rew_mid_c], width=0.17, color='gold', align='center')
    ax.bar(x3, [worst_count_p, worst_count_c], width=0.2, color='darkred',alpha=0.5, align='center', label='incorrect')
    ax.bar(x3, [rew_worst_p, rew_worst_c], width=0.17, color='darkred', align='center')
    ...
    title='block ' + str(block+1) + ', participant 8998, reward instrumental vs. pavlovian'
    ax.set_title(title)
