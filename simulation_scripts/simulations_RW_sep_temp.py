...
for i in range(count):
    ...
    for sim in range(sim_n):
        ...
        a, r, best, mid, worst = RW_sep_temp.simulate_change_accuracy(144, [0.5, 0.5, 0.5], alpha, beta, beta_new, changepoints, new_pos, new_probs)

        #a, r, best, mid, worst = RW_sep_temp.simulate_change_accuracy(144, [0.2, 0.5, 0.8], alpha, beta, [], [],[])

        #a,r,new_pos_1=RW_sep_temp.simulate_change_test(144, [0.5,0.5,0.5],alpha,beta, changepoints, new_pos, new_probs)

        #a,r=RW_sep_temp.simulate(144, [0.5,0.5,0.5],alpha,beta)
...
plt.scatter(beta_new_sim,acc_rew,c="green")
plt.scatter(beta_new_sim,acc_rew_bad,c="gray")
plt.title("best option")
plt.xlabel("temperature_new")
plt.grid()
plt.show()
...
plt.scatter(beta_new_sim,acc_rew_mid,c="yellow")
plt.scatter(beta_new_sim,acc_rew_mid_bad,c="gray")
plt.title("2nd best option")
plt.xlabel("temperature_new")
plt.grid()
plt.show()
...
plt.scatter(beta_new_sim,acc_rew_worst,c="red")
plt.scatter(beta_new_sim,acc_rew_worst_bad,c="gray")
plt.title("worst option")
plt.xlabel("temperature_new")
plt.grid()
plt.show()
