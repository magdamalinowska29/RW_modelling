...
for i in range(count):
    alpha_p=random.uniform(0,1)
    alpha_n = random.uniform(0, 1)
    beta=random.uniform(1,20)
    """simulation"""
    ...
    for sim in range(sim_n):
        ...
        a, r, best, mid, worst = RW_sep_lr.simulate_change_accuracy(180, [0.5, 0.5, 0.5], alpha_p, alpha_n, beta, changepoints, new_pos, new_probs)
    ...
    alpha_p_sim.append(alpha_p)
    alpha_n_sim.append(alpha_n)
...
plt.scatter(alpha_p_sim,acc_rew, c="green")
plt.scatter(alpha_p_sim,acc_rew_bad, c="gray")
plt.title("best option")
plt.xlabel("learning rate")
plt.grid()
plt.show()

plt.scatter(alpha_n_sim,acc_rew, c="green")
plt.scatter(alpha_n_sim,acc_rew_bad, c="gray")
plt.title("best option")
plt.xlabel("learning rate")
plt.grid()
plt.show()
...
plt.scatter(alpha_p_sim,acc_rew_mid,c="yellow")
plt.scatter(alpha_p_sim,acc_rew_mid_bad,c="gray")
plt.title("2nd best option")
plt.xlabel("learning rate")
plt.grid()
plt.show()

plt.scatter(alpha_n_sim,acc_rew_mid,c="yellow")
plt.scatter(alpha_n_sim,acc_rew_mid_bad,c="gray")
plt.title("2nd best option")
plt.xlabel("learning rate")
plt.grid()
plt.show()
...
plt.scatter(alpha_p_sim,acc_rew_worst,c="red")
plt.scatter(alpha_p_sim,acc_rew_worst_bad,c="gray")
plt.title("worst option")
plt.xlabel("learning rate")
plt.grid()
plt.show()

plt.scatter(alpha_n_sim,acc_rew_worst,c="red")
plt.scatter(alpha_n_sim,acc_rew_worst_bad,c="gray")
plt.title("worst option")
plt.xlabel("learning rate")
plt.grid()
plt.show()
