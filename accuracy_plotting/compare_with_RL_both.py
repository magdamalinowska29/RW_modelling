...
path_act= '/data/8998_r_p_example_results_action_observation.csv'
path_change= '/data/8998_r_p_example_results_new.csv'
...
path_act_i= '/data/8998_r_i_example_results_action_observation.csv'
path_change_i= '/data/8998_r_i_example_results_new.csv'
...
#observations=data_all_trials['Computer_Observations']
...
for block in range(n_blocks):
    ...
    best_count_c_curr, mid_count_c_curr, worst_count_c_curr, correct_ans_c=comp_block(comp_actions,stim_1_prob, stim_2_prob, stim_3_prob, block_end, block_start)
...
best_count_p_both+=best_count_p
mid_count_p_both+=mid_count_p
worst_count_p_both+=worst_count_p

rew_best_p_both+=rew_best_p
rew_mid_p_both+=rew_mid_p
rew_worst_p_both+=rew_worst_p

best_count_c_both+=best_count_c
mid_count_c_both+=mid_count_c
worst_count_c_both+=worst_count_c

rew_best_c_both+=rew_best_c
rew_mid_c_both+=rew_mid_c
rew_worst_c_both+=rew_worst_c


'''new data'''

path_act= '/data/8998_pe_p_example_results_action_observation.csv'
path_change= '/data/8998_pe_p_example_results_new.csv'
...
RW_2=Rescorla_Wagner_model()
comp_actions, comp_obs=RW_2.simulate_change(144,[0.5,0.5,0.5],0.31,7,changepoints, new_pos,new_probs)


path_act_i= '/data/8998_pe_i_example_results_action_observation.csv'
path_change_i= '/data/8998_pe_i_example_results_new.csv'
...
x3=[1.4,2.4]
ax = plt.subplot(111)
ax.bar(x, [best_count_p_both, best_count_c_both], width=0.2, color='darkgreen',alpha=0.5, align='center', label='correct')
ax.bar(x, [rew_best_p_both, rew_best_c_both], width=0.17, color='darkgreen', align='center')
ax.bar(x2, [mid_count_p_both, mid_count_c_both], width=0.2, color='gold', alpha=0.4, align='center', label='2nd best')
ax.bar(x2, [rew_mid_p_both, rew_mid_c_both], width=0.17, color='gold', align='center')
ax.bar(x3, [worst_count_p_both, worst_count_c_both], width=0.2, color='darkred',alpha=0.5, align='center', label='incorrect')
ax.bar(x3, [rew_worst_p_both, rew_worst_c_both], width=0.17, color='darkred', align='center')
