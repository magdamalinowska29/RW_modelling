...
path_act= '/data/0_r_p_example_results_action_observation.csv'
path_change= '/data/0_r_p_example_results_new.csv'
...
path_act_i= '/data/0_r_i_example_results_action_observation.csv'
path_change_i= '/data/0_r_i_example_results_new.csv'
...
path_act= '/data/0_pe_p_example_results_action_observation.csv'
path_change= '/data/0_pe_p_example_results_new.csv'
...
path_act_i= '/data/0_pe_i_example_results_action_observation.csv'
path_change_i= '/data/0_pe_i_example_results_new.csv'
...
x3=[1.4,2.4]
ax = plt.subplot(111)
ax.bar(x, [best_count_p_both, best_count_c_both], width=0.2, color='mediumseagreen',alpha=0.5, align='center', label='correct')
ax.bar(x, [rew_best_p_both, rew_best_c_both], width=0.17, color='mediumseagreen', align='center')
ax.bar(x2, [mid_count_p_both, mid_count_c_both], width=0.2, color='yellow', alpha=0.4, align='center', label='2nd best')
ax.bar(x2, [rew_mid_p_both, rew_mid_c_both], width=0.17, color='yellow', align='center')
ax.bar(x3, [worst_count_p_both, worst_count_c_both], width=0.2, color='red',alpha=0.5, align='center', label='incorrect')
ax.bar(x3, [rew_worst_p_both, rew_worst_c_both], width=0.17, color='red', align='center')
