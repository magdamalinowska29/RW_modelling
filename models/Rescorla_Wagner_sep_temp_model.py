...
class Rescorla_Wagner_sep_temp_model():
    ...
    """this model has seperate betas for the first trial after the introduction of the new stimulus"""
    ...
    def simulate_change(self, T, mu, alpha, beta, beta_new, changepoints, new_pos, new_probs):
        """a function to simulate the task choices using a rascola wagner model
                ...
                Parameters:
                    ...
                    beta: float, reverse temperature, controls the level of stochasticity of the choice. 0 means completelt random
                     ...
                     beta_new: float, the beta for the first trial with new stimulus
    ...
    def simulate_change_accuracy(self, T, mu, alpha, beta, beta_new, changepoints, new_pos, new_probs):
    ...
    def simulate_change_test(self, T, mu, alpha, beta, beta_new, changepoints, new_pos, new_probs):
        """a function to simulate the task choices using a rascola wagner model
    ...
    def likelihood_change(self,a,r, alpha, beta, beta_new, changepoints, new_pos):
    ...
    def likelihood_change_pav(self, a, a_comp, r, alpha, beta, beta_new, changepoints, new_pos):
    ...
    def likelihood_change_test(self, a, r, alpha, beta, beta_new, changepoints, new_pos):
    ...
    def likelihood_change_pav_test(self, a, a_comp, r, alpha, beta, beta_new, changepoints, new_pos):
    ...
    def fit(self,a,r):
        ...
        init_guess_1 = random.uniform(0.1, 1)
        init_guess_2 = random.uniform(1, 30)
        ...
        res=minimize(fun=obFunc,x0=X0, method='L-BFGS-B',bounds=[(0.1,1),(1,30),(1,30)])
    ...
    def fit_pav(self, a, a_comp, r):
        ...
        res=minimize(fun=obFunc,x0=X0, method='L-BFGS-B',bounds=[(0.2,1),(2,12),(2,12)])
    ...
    def fit_change(self,a,r, changepoints, new_pos):
        ...
        obFunc =lambda x: self.likelihood_change(a, r, changepoints=changepoints, new_pos=new_pos,alpha=x[0], beta=x[1], beta_new=x[2])
        ...
        '''
        alpha_X = get_truncated_normal(mean=0.2727133417, sd=0.2497262032, low=0, upp=1)
        init_guess_1 = alpha_X.rvs()

        beta_X = get_truncated_normal(mean=13.28568807, sd=11.11637206, low=2, upp=30)
        init_guess_2 = beta_X.rvs()

        beta_X_new = get_truncated_normal(mean=49.9096576, sd=20.58905188, low=2, upp=100)
        init_guess_3 = beta_X_new.rvs()'''

        X0 = [init_guess_1, init_guess_2, init_guess_3];


        res=minimize(fun=obFunc,x0=X0, method='L-BFGS-B',bounds=[(0,1),(1,math.inf),(1,math.inf)])
    ...
    def fit_change_pav(self, a, a_comp, r, changepoints, new_pos):
        ...
        obFunc =lambda x: self.likelihood_change_pav(a, a_comp, r, changepoints=changepoints, new_pos=new_pos,alpha=x[0], beta=x[1], beta_new=x[2])
    ...
    def fit_change_test(self,a,r, changepoints, new_pos):
        ...
        obFunc =lambda x: self.likelihood_change_test(a, r, changepoints=changepoints, new_pos=new_pos,alpha=x[0], beta=x[1], beta_new=x[2])
        ...
        init_guess_2 = random.normal(loc=8.684382077, scale=0.7425075939)
        ...
        res=minimize(fun=obFunc,x0=X0, method='L-BFGS-B',bounds=[(0,1),(0,40),(0,40)])
    ...
    def fit_change_pav_test(self, a, a_comp, r, changepoints, new_pos):
        ...
        obFunc =lambda x: self.likelihood_change_pav_test(a, a_comp, r, changepoints=changepoints, new_pos=new_pos,alpha=x[0], beta=x[1], beta_new=x[2])
