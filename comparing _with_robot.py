...
for block in range(n_blocks):
    ...
    best_count_c, mid_count_c, worst_count_c, correct_ans_c=part_block(comp_actions,stim_1_prob, stim_2_prob, stim_3_prob, block_end, block_start)
    ...
    x3=[1.4,2.4]
    ax = plt.subplot(111)
    ax.bar(x, [best_count_p, best_count_c], width=0.2, color='mediumseagreen',alpha=0.5, align='center', label='correct')
    ...
    title='block ' + str(block+1) + ', participant 0, percpetual instrumental vs. pavlovian'
    ax.set_title(title)
