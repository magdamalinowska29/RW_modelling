...
dict = {'lr': lr_val, 'temp': temp_val, 'lr_CK': lr_CK_val, 'temp_CK': temp_CK_val, 'LL': LL_val, 'BIC': BIC_val, 'AIC': AIC_val}


df = pd.DataFrame(dict)

df.to_csv('data/fitting_RW_CK_results_pe_p_pav.csv')
